'''
Script for evaluating world_model real rollouts on stage 2.
'''
...
if __name__ == "__main__":
    ...
    if args.output_folder is None:
        args.output_folder = f"evaluation/real/{os.path.basename(args.load_model_from).split('.')[0]}/{args.manuals}/"
