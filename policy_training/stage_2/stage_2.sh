...
CMD="python ../train.py --splits_path ../../offline_training/custom_dataset/data_splits_final_with_test.json --stage 2 --lr 0.00005 --update_timestep 64 --optimizer Adam --weight_decay 0.0 --max_time 47.75 --max_steps 64 --gamma 0.99 --freeze_attention --entity $ENTITY --log_group $LOG_GROUP"
